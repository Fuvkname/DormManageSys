...
<div class="container">
    ...
    <div class="row">
        <div class="col-auto mr-auto">
            <!--搜索框-->
            <form action="/selectDormByInput" method="post">
...
<%--                <a href="/getAllDorm?pageNum=${pageInfo.pageNum-1}&pageSize=${pageInfo.pageSize}">上一页</a>--%>
<%--            </c:if>--%>
<%--        </td>--%>
<%--        <td>第${pageInfo.pageNum}/共${pageInfo.pages}</td>--%>
<%--        <td>--%>
<%--            <c:if test="${pageInfo.hasNextPage}">--%>
<%--                <a href="/getAllDorm?pageNum=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}">下一页</a>--%>
<%--            </c:if>--%>
<%--        </td>--%>
<%--    </tr>--%>
<%--</table>--%>
<nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center">
        <c:if test="${pageInfo.hasPreviousPage}">
            <li class="page-item">
                <a class="page-link" href="/getAllDorm?pageNum=${pageInfo.pageNum-1}&pageSize=${pageInfo.pageSize}">上一页</a>
            </li>
        </c:if>
        <c:if test="${!pageInfo.hasPreviousPage}">
        ...
        <c:if test="${pageInfo.hasNextPage}">
            <li class="page-item ">
                <a  class="page-link" href="/getAllDorm?pageNum=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}">下一页</a>
            </li>
        </c:if>
        <c:if test="${!pageInfo.hasNextPage}">
            <li class="page-item disabled">
